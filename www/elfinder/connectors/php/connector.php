...
$params["basePath"] = str_replace("/elfinder/connectors/php", "", preg_replace('#https?://[^/]+#A', '', $params["baseUrl"]));

$opts = array(
	'root'            => '../../../public/upload',                       // path to root directory
	'URL'             => $params["basePath"] . '/public/upload/', // root directory URL
